...
import ClientModal from "./client/ClientModal"; // Import the modal component
...
const Navbar = () => {
  ...
  const handleProfileClick = () => {
    setModalOpen(true); // Open modal when profile is clicked
  };
  ...
  return (
    <div>
      <nav className="bg-[#27235c] text-white p-3 flex justify-between items-center fixed w-full top-0 left-0 z-50">
          ...
          <button>
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M12 22c4.418 0 8-3.582 8-8s-3.582-8-8-8 -8 3.582-8 8 3.582 8 8z"
              ></path>
            </svg>
          </button>
          <button>
                ...
                >
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="2"
                      d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8m-2 8V5a2 2 0 00-2-2H7a2 2 0 002 2v11m14 0a2 2 0 002-2H5a2 2 0 002 2z"
                    ></path>
                  </svg>
                  Inbox
                </a>
      ...
      {/* Render the modal */}
      {modalOpen && (
        <ClientModal isOpen={modalOpen} onClose={closeModal} user={user} />
      )}
    </div>
  );
};
